package org.uit.utimea.features.subject.controller;
...
public class SubjectController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> create(@RequestBody SubjectRequest request, HttpServletRequest httpServletRequest) {
    ...
    public ResponseEntity<ApiResponse> getAll(@RequestBody(required = false) PageAndFilterDTO<SubjectFilter> pageAndFilterDTO, HttpServletRequest httpServletRequest) {
        if (pageAndFilterDTO == null) {
            pageAndFilterDTO = new PageAndFilterDTO<>();
        }
        var pagination = subjectService.getAll(pageAndFilterDTO);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse> update(@PathVariable Long id, @RequestBody SubjectRequest request, HttpServletRequest httpServletRequest) {
